<template>
    <v-container style="padding: 0px ">
        <v-row class="pa-5 align-center">
            ...
            <v-col cols="11">
                <h2 class="font-weight-bold text-center">Mantenimiento de Documento Personal</h2>
            </v-col>
        </v-row>
                        ...
                        <template v-slot:[`item`]="{ item }">
                            ...
                            <td> 
                                <v-tooltip bottom> 
                                    ...
                                    v-on="on"
                                    class="mr-2"  
                                    @click="showEditarDocumento(item)"
                                    color="blue-grey">
                                    mdi-border-color                            
                                    </v-icon>
                                    </template >
                                ...
                                <v-tooltip bottom> 
                                    <template v-slot:activator="{ on, attrs }">        
                                        <v-icon 
                                            v-bind="attrs"
                                            v-on="on"
                                            class="mr-2"   @click="deletePersonal(item)" 
    ...
    data() {
        return {
            ...
            headers: [
                ...
                { text: "Código", sortable: false, value: "CodigoSUNAT" , class:'light blue darken-4 white--text'},

                { text: "Acciones", value: "actions" , class:'light blue darken-4 white--text', width: "15%"},
            ],
            Nombre : "",
            CodigoSUNAT: "",
            CantidadMinima : "",
